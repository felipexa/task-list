...
export const editStatus = (id, change) => axios.patch(`${baseUrlTask}/${id}`, change).then((resp) => resp.data);

export const getTaskList = () => axios.get(baseUrlTaskList).then((resp) => resp.data);
export const addTaskList = (data) => axios.post(baseUrlTask, data).then((resp) => resp.data);